...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama_kategori)) {
        ...
        $stmt->bind_param("ssi", $nama_kategori, $deskripsi, $category_id);
...
<head>
    ...
    <title>Edit Kategori - Admin <?= $settings['site_name'] ?></title>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="deskripsi" name="deskripsi"><?= $category['deskripsi'] ?></textarea>
                        </div>
