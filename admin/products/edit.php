...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama_produk) || empty($harga)) {
        ...
        global $conn;
        $stmt = $conn->prepare("UPDATE products SET nama_produk = ?, deskripsi = ?, harga = ?, kategori_id = ?, status = ? WHERE id = ?");
        $stmt->bind_param("ssdisi", $nama_produk, $deskripsi, $harga, $kategori_id, $status, $product_id);
...
<head>
    ...
    <title>Edit Produk - Admin <?= $settings['site_name'] ?></title>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="harga" name="harga" min="0" step="100" value="<?= $product['harga'] ?>" required>
                        </div>
