...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] === UPLOAD_ERR_OK) {
        $gambar = uploadImage($_FILES['gambar'], '../../assets/images/trips/');
    }

    if (addTrip($nama_trip, $slug, $deskripsi, $itinerary, $harga, $kapasitas, $tanggal_mulai, $tanggal_selesai, $tingkat_kesulitan, $lokasi, $gambar, $include, $exclude, $status)) {
        echo "<script>alert('Trip berhasil ditambahkan'); window.location.href='index.php';</script>";
    } else {
        echo "<script>alert('Gagal menambahkan trip');</script>";
    }
}
?>
...
<head>
    ...
    <title>Tambah Open Trip - Admin <?= $settings['site_name'] ?></title>
...
<body>
    ...
    <main class="main-content">
        <header class="admin-header">
            <h1 class="header-title">Tambah Open Trip</h1>
        ...
        <div class="content">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Form Tambah Open Trip</h2>
                </div>
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_trip" required placeholder="Contoh: Gunung Semeru 3D2N">
                            </div>
                            <div class="form-group">
                                <label>Slug URL</label>
                                <input type="text" name="slug" placeholder="auto-generate dari nama">
                            </div>
                            <div class="form-group">
                                <label>Lokasi *</label>
                                <input type="text" name="lokasi" required placeholder="Contoh: Jawa Timur, Lumajang">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="kapasitas" required placeholder="20" value="20">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="tingkat_kesulitan">
                                    ...
                                    <option value="moderate" selected>Moderate (Sedang)</option>
                            ...
                            <div class="form-group full-width">
                                ...
                                <textarea name="deskripsi" placeholder="Deskripsi trip..."></textarea>
                            </div>
                            <div class="form-group full-width">
                                <label>Itinerary (Plan Perjalanan)</label>
                                <textarea name="itinerary" placeholder="Hari 1: ...&#10;Hari 2: ..."></textarea>
                            </div>
                            <div class="form-group full-width">
                                <label>Include (Yang Sudah Include)</label>
                                <textarea name="include" placeholder="Tenda, Sleeping Bag, Guide, Meals..."></textarea>
                            </div>
                            <div class="form-group full-width">
                                <label>Exclude (Yang Tidak Include)</label>
                                <textarea name="exclude" placeholder="Personal expenses, Flight tickets..."></textarea>
                            </div>
                            <div class="form-group full-width">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn-submit"><i class="fas fa-save"></i> Simpan Trip</button>
