...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($nama_lengkap) || empty($email)) {
        ...
        if (updateUser($id, $username, $nama_lengkap, $email, $role, $status)) {
...
<head>
    ...
    <title>Edit Karyawan - Admin <?= $settings['site_name'] ?></title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-group .hint { font-size: 0.875rem; color: var(--gray-600); margin-top: 5px; }
...
<body>
    ...
    <main class="main-content">
        <header class="admin-header">
            <h1 class="header-title">Edit Karyawan</h1>
        ...
        <div class="content">
            <div class="card">
                <div class="card-header">
                    <h2 class="card-title">Form Edit Karyawan</h2>
                </div>
                <div class="card-body">
                    <?php if ($error): ?>
