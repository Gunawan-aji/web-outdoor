...
<head>
    ...
    <title>Kelola Karyawan - Admin <?= $settings['site_name'] ?></title>
...
<body>
    ...
    <main class="main-content">
        <header class="admin-header">
            <h1 class="header-title">Kelola Karyawan</h1>
        ...
        <div class="content">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="add.php" class="btn-add"><i class="fas fa-plus"></i> Tambah Karyawan</a>
                </div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php foreach ($users as $index => $user): ?>
                            <tr>
                                ...
                                <td><?= $user['email'] ?></td>
                                <td><span class="status-badge <?= $user['role'] ?>"><?= ucfirst($user['role']) ?></span>
                                </td>
                                <td><span class="status-badge <?= $user['status'] ?>"><?= $user['status'] ?></span></td>
                                <td>
                                    <div class="action-btns">
                                        <a href="edit.php?id=<?= $user['id'] ?>" class="btn-action btn-edit" title="Edit"><i
                                                class="fas fa-edit"></i></a>
                                        <?php if ($user['role'] != 'admin'): ?>
                                            <a href="delete.php?id=<?= $user['id'] ?>" class="btn-action btn-delete"
                                                title="Hapus" onclick="return confirm('Yakin hapus karyawan ini?')"><i
