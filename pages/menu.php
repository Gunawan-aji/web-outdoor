...
<head>
    ...
    <title>Sewa Alat Outdoor - <?= $settings['site_name'] ?></title>
    <meta name="description"
        content="Sewa alat outdoor berkualitas: tenda, sleeping bag, carrier, kompor dan masih banyak lagi">
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1 class="page-title">Sewa Alat Outdoor</h1>
    ...
    <!-- Equipment Section -->
    <section class="section equipment-section" style="background: var(--light);">
        <div class="container">
            <!-- Category Filter -->
            <div class="equipment-categories" style="margin-bottom: 40px;">
                <a href="menu.php" class="category-btn <?= !$category_id ? 'active' : '' ?>">Semua</a>
            ...
            <?php if (empty($products)): ?>
                <div style="text-align: center; padding: 60px 20px;">
                    <i class="fas fa-campground" style="font-size: 4rem; color: var(--gray-300); margin-bottom: 20px;"></i>
                    <h3 style="margin-bottom: 10px;">Alat tidak ditemukan</h3>
                    <p style="color: var(--gray-600);">Silakan pilih kategori lain atau kembali lagi nanti.</p>
                </div>
            <?php endif; ?>
        </div>
    </section>
            ...
            <div class="footer-grid">
                ...
                <div class="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href="menu.php">Sewa Alat</a></li>
